...
tk.messagebox.showinfo('Traffic Signal', 'We will assume the traffic signal is RED', icon='warning')


filename="output.avi"
codec=cv2.VideoWriter_fourcc('m', 'p', '4', 'v')     #VideoWriter_fourcc('m','p','4','v')#fourcc means four character code
framerate=10
resolution=(640,480)
